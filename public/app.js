...
async function renderEvidence(){
 ...
 main.querySelector('.notice').textContent='Not yet validated: physical-phone loading and carriage GPS; verified corridor rail geometry; MapTiler online layer; fixed AI provider evaluation; reviewed narration and second language; six-person user trial; four-hour endurance; independent relevant-environment review. The current AI mode is an experimental source-locked smoke test, and the hosted D1 room board has passed a two-room automated isolation smoke test. TRL 5 is not claimed.';
