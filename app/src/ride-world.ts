...
export function installRideWorld(map: MapType, world: RideWorldModel, openHub: (hubId: string) => void) {
  ...
  map.addLayer({ id: 'ride-hub-billboards', type: 'symbol', source: 'ride-hubs', layout: { 'icon-image': ['case', ['get', 'discovered'], 'ride-pin-lit', 'ride-pin-dim'], 'icon-size': proximitySize, 'icon-allow-overlap': true, 'text-field': ['get', 'label'], 'text-font': ['Noto Sans Bold'], 'text-size': 14, 'text-variable-anchor': ['top', 'bottom', 'left', 'right'], 'text-radial-offset': 1.5, 'text-allow-overlap': true }, paint: { 'text-color': ['case', ['get', 'discovered'], '#fff4ca', '#c6ccd2'], 'text-halo-color': '#101820', 'text-halo-width': 2, 'text-opacity': ['interpolate', ['linear'], ['get', 'proximity'], 0, 1, 35_000, 0.85, 120_000, 0] } });
  map.addLayer({ id: 'ride-attraction-silhouettes', type: 'symbol', source: 'ride-attractions', layout: { 'icon-image': ['case', ['get', 'discovered'], 'ride-landmark-lit', 'ride-landmark-dim'], 'icon-size': proximitySize, 'icon-allow-overlap': true, 'text-field': ['get', 'label'], 'text-font': ['Noto Sans Regular'], 'text-size': 12, 'text-variable-anchor': ['top', 'bottom', 'left', 'right'], 'text-radial-offset': 1.4 }, paint: { 'text-color': ['case', ['get', 'discovered'], '#fff0b6', '#bac1c8'], 'text-halo-color': '#101820', 'text-halo-width': 2, 'text-opacity': ['interpolate', ['linear'], ['get', 'proximity'], 0, 1, 20_000, 0.72, 80_000, 0] } });
