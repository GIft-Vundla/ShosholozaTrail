...
- Guests do not need a carriage room. A daily rotating hash of Cloudflare's connection IP receives five requests per day. Valid carriage sessions retain a ten-request daily allowance. The global application budget is 100 requests per day.
